...
public class GenerateExpensesReportExcelUseCase : IGenerateExpensesReportExcelUseCase
{
    ...
    public async Task<byte[]> Execute(DateTime month)
    {
        ...
        workbook.Author = "Giovani";
        workbook.Style.Font.FontSize = 12;
        workbook.Style.Font.FontName = "Montserrat";
        
        var worksheet = workbook.Worksheets.Add($"{ResourceReportGenerationMessages.REPORT} - {month:Y}");
    ...
    private void InsertHeader(IXLWorksheet worksheet)
    {
        ...
        worksheet.Cells("A1:E1").Style.Fill.BackgroundColor = XLColor.FromHtml("#8700ff");
